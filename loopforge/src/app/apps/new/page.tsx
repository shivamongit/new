...
export default function NewAppPage() {
  ...
  const [form, setForm] = useState({
    name: "",
    description: "",
    workDir: "C:\\LoopForge\\apps\\my-poc",
    command: "npm",
    arguments: "start",
    port: 3000,
    healthUrl: "",
          ...
          {step === 1 && !deploying && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  LoopForge will run the bounded deploy loop with up to 3 attempts
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <dl className="space-y-3 text-sm">
                  ...
                  <ReviewRow label="Service" value={`LoopForge-${form.name.toLowerCase().replace(/\s+/g, "-")}`} />
