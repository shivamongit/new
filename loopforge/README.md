...
![LoopForge](https://img.shields.io/badge/platform-Windows%20%7C%20Dev%20simulate-violet)
...
2. Place `nssm.exe` in `C:\LoopForge\bin\`
3. In LoopForge **Settings**, disable **Simulate mode**
4. Set NSSM path to `C:\LoopForge\bin\nssm.exe`
